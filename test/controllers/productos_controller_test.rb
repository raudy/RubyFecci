...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { categoria_id: @producto.categoria_id, cod: @producto.cod, nombre: @producto.nombre }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { categoria_id: @producto.categoria_id, cod: @producto.cod, nombre: @producto.nombre }
    assert_redirected_to producto_path(assigns(:producto))
  end
