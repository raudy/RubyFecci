class CategoriaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categorium.save
        format.html { redirect_to @categorium, notice: 'Categoría creada con éxito.' }
  ...
  def update
    respond_to do |format|
      if @categorium.update(categorium_params)
        format.html { redirect_to @categorium, notice: 'Categoría editada con éxito.' }
  ...
  def destroy
    @categorium.destroy
    respond_to do |format|
      format.html { redirect_to categoria_url, notice: 'Categoría eliminada con éxito.' }
  ...
  private
    ...
    def categorium_params
      params.require(:categorium).permit(:cod, :nombre)
    end
end
